...
//Fonction principale
function init() {
	fetch("https://api.open-meteo.com/v1/forecast?latitude=45.62&longitude=-0.35&timezone=auto&current_weather=true&hourly=temperature_2m,relativehumidity_2m,windspeed_10m") //API avec coordonnées de Rennes
